...
public class SpringDataJpaMultipleDbConfigurationsApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringDataJpaMultipleDbConfigurationsApplication.class, args);
	}
	...
	/*
	SpringDataJpaMultipleDbConfigurationsApplication
	SpringApplication.run(SpringDataJpaMultipleDbConfigurationsApplication.class, args);
	}
