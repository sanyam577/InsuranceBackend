...
public class CustomerController {
	...
	public ResponseEntity<Customer> showAllCustomer(@PathVariable Integer id) {
		...
		customer.setStudies(new ArrayList<>(Arrays.asList("10th", "12th", "Engineering")));
		customer.setPhoneNumbers(new HashSet<>(Arrays.asList(9994445556L, 994349845L, 98765678L)));
		Map<String, Object> idDetails = new HashMap<>();
		idDetails.put("adhar", 99453123432L);
		idDetails.put("panNo", "DOOPQRCL12");
